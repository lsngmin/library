...
<div class="main-container">
  ...
  <div class="content">
    <section class="search-container">
      ...
      <section class="results-container">
        <div class="result-item">
          <img src="img/gun3.png" alt="책 이미지">
          <div class="result-details">
            <p class="subject">사회과학</p>
            <h4>(10대를 위한) 총균쇠 수업 <input type="checkbox"></h4>
            <p>저 자: 김정진 지음</p>
            <p>발행처: 넥스트씨</p>
            <p>발행년: 2023</p>
            <div class="result-actions">
      ...
      <section class="results-container">
        <div class="result-item">
          <img src="img/gun2.png" alt="책 이미지">
          <div class="result-details">
            <p class="subject">사회과학</p>
            <h4>총, 균, 쇠 : 무기·병균·금속은 인류의 운명을 어떻게 바꿨는가 <input type="checkbox"></h4>
            <p>저자: 재레드 다이아몬드</p>
            <p>발행처: 문학사상</p>
            <p>발행년: 2014</p>
            <div class="result-actions">
